...
import org.loon.framework.game.simple.GameView;
import org.loon.framework.game.simple.IGameView;
...
public class Deploy {
	...
	public synchronized boolean addComponent(int x, int y, int w, int h,
		...
		if (!LSystem.isApplet
				&& game.getScene().getIScene().getType() == Model.Awt) {
