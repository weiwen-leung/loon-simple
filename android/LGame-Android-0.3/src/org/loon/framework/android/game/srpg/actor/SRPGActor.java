...
public class SRPGActor implements LRelease {
	...
	private SRPGAnimation move, attack;
	...
	public SRPGActor(String name, String fileName, int index, int level,
		...
		this(SRPGActorFactory.makeActorStatus(name, index, level, team),
				SRPGAnimation.makeRMVXObject(fileName), null, tileWidth,
				tileHeight);
	}

	public SRPGActor(String name, int index, int level, int team,
			SRPGAnimation animation, int tileWidth, int tileHeight) {
		this(SRPGActorFactory.makeActorStatus(name, index, level, team),
				animation, null, tileWidth, tileHeight);
	}

	public SRPGActor(SRPGStatus status, SRPGAnimation animation, int tileWidth,
			int tileHeight) {
		this(status, animation, null, tileWidth, tileHeight);
	}

	public SRPGActor(SRPGStatus status, SRPGAnimation mv, SRPGAnimation atk,
	 ...
	 * @return
	 */
	public LImage[] getAnimationImages(final SRPGAnimation o, final int d) {
		LImage[] result = null;
		switch (d) {
		// 向下移动
