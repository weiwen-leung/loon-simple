 ...
 * @version 0.1.2
 */
public final class LGraphicsAndroid2D extends LGraphicsMath implements
		LGraphics {

	private final static android.graphics.PaintFlagsDrawFilter drawFilter = new android.graphics.PaintFlagsDrawFilter(
	...
	public void drawPixmap(LPixmap pix, int x, int y) {
		...
		canvas.drawBitmap(pix.getData(), 0, pix.getWidth(), x, y, pix
				.getWidth(), pix.getHeight(), !pix.isOpaque(), paint);
	}
