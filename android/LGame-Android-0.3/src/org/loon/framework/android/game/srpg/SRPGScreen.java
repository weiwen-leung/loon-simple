...
import org.loon.framework.android.game.srpg.actor.SRPGAnimation;
...
public abstract class SRPGScreen extends Screen implements SRPGType, Runnable {
	 ...
	 * @return
	 */
	public final void onTouchDown(final Touch e) {
	...
	public abstract void onDown(Touch e);
	 ...
	 * @return
	 */
	public final void onTouchUp(Touch e) {
		if (!isEventLoop || isSrpgTouchLock) {
			return;
		}
		onUp(e);
	...
	public abstract void onUp(Touch e);
	 ...
	 * @param e
	 */
	public final void onTouchMove(final Touch e) {
	...
	public abstract void onMove(Touch e);
