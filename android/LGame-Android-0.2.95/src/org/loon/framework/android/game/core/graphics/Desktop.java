...
import org.loon.framework.android.game.core.graphics.window.LPanel;
import org.loon.framework.android.game.core.graphics.window.LUI;
import org.loon.framework.android.game.core.graphics.window.UIConfig;
...
public class Desktop {
	...
	public void add(LComponent comp) {
		...
		if (comp.isFull) {
			this.input.setRepaintMode(IScreen.SCREEN_NOT_REPAINT);
		}
