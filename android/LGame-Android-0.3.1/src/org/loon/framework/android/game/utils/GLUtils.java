...
public class GLUtils {
	...
	private static FloatBuffer lazyVertex2FloatBuffer;

	private static FloatBuffer lazyVertex3FloatBuffer;
	...
	public static void vertex2Pointer(GL10 gl10, FloatBuffer buffer) {
		if (lazyVertex2FloatBuffer != buffer) {
			lazyVertex2FloatBuffer = buffer;
			gl10.glVertexPointer(2, GL10.GL_FLOAT, 0, buffer);
		}
	}

	public static void vertex3Pointer(GL10 gl10, FloatBuffer buffer) {
		if (lazyVertex3FloatBuffer != buffer) {
			lazyVertex3FloatBuffer = buffer;
