...
public abstract class Line2D implements Cloneable {
	...
	public boolean intersects(double x, double y, double w, double h) {
		return intersects(new RectBox((int) x, (int) y, (int) w, (int) h));
	}
	 ...
	 * @since 1.2
	 */
	public boolean intersects(RectBox r) {
		return r.intersectsLine((int) getX1(), (int) getY1(), (int) getX2(),
				(int) getY2());
	}
	 ...
	 * @since 1.2
	 */
	public boolean contains(RectBox r) {
		return false;
	}

	public RectBox getBounds() {
		return new RectBox((int) getX1(), (int) getY1(), (int) getX2(),
				(int) getY2());
	}
