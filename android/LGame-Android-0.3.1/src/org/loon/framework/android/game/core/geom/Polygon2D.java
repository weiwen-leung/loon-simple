...
public class Polygon2D {
	...
	public Triangle2f[] getTriangles() {
		...
		LinkedList<Triangle2f> triangles = new LinkedList<Triangle2f>();
		...
		if (this.points.size() == 3) {
			...
			triangles.add(new Triangle2f(x1, y1, x2, y2, x3, y3));
		...
		return triangles.toArray(new Triangle2f[0]);
	}
