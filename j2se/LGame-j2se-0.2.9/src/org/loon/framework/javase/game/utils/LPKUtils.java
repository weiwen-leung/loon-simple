...
import org.loon.framework.javase.game.core.resource.LPKType;
...
public class LPKUtils extends LPKResource {
	...
	public static void makeLPKFile(String srcFileName, String makeFilePath) {
		makeLPKFile(srcFileName, makeFilePath, Long.parseLong(PassWordUtils
				.toNumberPassword(LPKType.LF_PASSWORD_LENGTH)));
	}
	...
	public static void writeByteArray(byte[] bytes,
		...
		for (int i = 0; i < bytes.length; dos
				.writeByte(bytes[i]), i++)
			;
	}
