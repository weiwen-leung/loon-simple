...
public class Java2DView extends Java2DCanvas implements IView, Runnable,
	...
	private int drawSleepTimeMicros;
	...
	public void run() {
		...
		do {
			...
			if (reapint) {
				repaintMode = screen.getRepaintMode();
				switch (repaintMode) {
				...
				case IScreen.SCREEN_NOT_REPAINT:
					break;
				default:
					gl.drawImage(screen.getBackground(), repaintMode / 2
			...
			if (maxFrames == MAX_FPS) {
				...
				long goalTimeMicros = lastTimeMicros + 1000000L / maxFrames;
