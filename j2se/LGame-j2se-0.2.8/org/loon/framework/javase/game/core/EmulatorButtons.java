...
public class EmulatorButtons {
	...
	public EmulatorButtons(EmulatorListener el) {
		this(el, GameManager.getSystemHandler().getWidth(), GameManager
	...
	public EmulatorButtons(EmulatorListener el, int w, int h) {
		...
		this.dpad = GraphicsUtils.loadImage("system/image/e1.png");
		this.buttons = GraphicsUtils.loadImage("system/image/e2.png");
		this.width = w;
		this.height = h;
	...
	public void setLocation(int x, int y) {
		...
		if (GameManager.getSystemHandler().getHeight() <= 320) {
