...
import org.loon.framework.javase.game.media.DataBuffer;
import org.loon.framework.javase.game.media.DataChannel;
import org.loon.framework.javase.game.media.DataSample;
import org.loon.framework.javase.game.media.DataStream;
import org.loon.framework.javase.game.utils.DateUtils;
import org.loon.framework.javase.game.utils.FileUtils;
import org.loon.framework.javase.game.utils.GraphicsUtils;
import org.loon.framework.javase.game.utils.http.ExternalDownload;
import org.loon.framework.javase.game.utils.http.States;
...
public class LPlayer extends LContainer implements IMpeg4 {
	...
	public LPlayer(int x, int y, int width, int height) {
		...
		this.wait = new WaitAnimation(0,width, height);
		this.wait.white();
