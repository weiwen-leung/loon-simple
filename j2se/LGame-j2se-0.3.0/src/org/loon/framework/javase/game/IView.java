...
public interface IView {
	...
	public abstract Image getAwtImage();
	...
	public abstract boolean isShowMemory();
	
	public abstract void setShowLogo(boolean showLogo);

	public abstract void setShowMemory(boolean showMemory);

	public abstract void setLogo(Image logo);

	public abstract void setLogo(String fileName);
