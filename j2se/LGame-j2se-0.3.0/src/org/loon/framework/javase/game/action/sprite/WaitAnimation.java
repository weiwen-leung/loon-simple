...
public class WaitAnimation {
	...
	private final Color defaultBlackColor;

	private final Color defaultWhiteColor;
	...
	public WaitAnimation(int s, int width, int height) {
		...
		this.width = width;
		this.height = height;
		this.defaultBlackColor = new Color(0.5f, 0.5f, 0.5f);
		this.defaultWhiteColor = new Color(240, 240, 240);
