...
public class Sprites implements Serializable {
	...
	public Sprites() {
		this.visible = true;
		this.width = GameManager.getSystemHandler().getWidth();
		this.height = GameManager.getSystemHandler().getHeight();
		this.sprites = new ISprite[capacity];
	}
	 ...
	 * @return
	 */
	public synchronized ArrayList getSprites(Class clazz) {
		if (clazz == null) {
			return null;
		}
