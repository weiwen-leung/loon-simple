...
public abstract class Curve {
	...
	public static void insertMove(Vector<Order0> curves, double x, double y) {
		curves.add(new Order0(x, y));
	}

	public static void insertLine(Vector<Order1> curves, double x0, double y0,
			double x1, double y1) {
		if (y0 < y1) {
	...
	public static void insertQuad(Vector<Curve> curves, double x0, double y0,
			double coords[]) {
		double y1 = coords[3];
		if (y0 > y1) {
	...
	public static void insertCubic(Vector<Curve> curves, double x0, double y0,
			double coords[]) {
		double y1 = coords[5];
		if (y0 > y1) {
