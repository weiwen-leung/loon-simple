...
public class FreedomEffect implements ISprite {
	...
	public static FreedomEffect getSnowEffect(int count, int x, int y) {
		return FreedomEffect.getSnowEffect(count, x, y, LSystem
				.getSystemHandler().getWidth(), LSystem.getSystemHandler()
				.getHeight());
	}
	...
	public static FreedomEffect getRainEffect(int count, int x, int y) {
		return FreedomEffect.getRainEffect(count, x, y, LSystem
				.getSystemHandler().getWidth(), LSystem.getSystemHandler()
				.getHeight());
	}
	...
	public static FreedomEffect getPetalEffect(int count, int x, int y) {
		return FreedomEffect.getPetalEffect(count, x, y, LSystem
				.getSystemHandler().getWidth(), LSystem.getSystemHandler()
				.getHeight());
	}
	...
	public FreedomEffect(Class<?> clazz, int count, int limit, int x, int y) {
		this(clazz, count, limit, x, y, LSystem.getSystemHandler()
				.getWidth(), LSystem.getSystemHandler().getHeight());
	}
