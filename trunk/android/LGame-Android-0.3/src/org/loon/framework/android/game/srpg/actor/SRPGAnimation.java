...
public class SRPGAnimation {
	...
	private final static HashMap<String, SRPGAnimation> animations = new HashMap<String, SRPGAnimation>();
	...
	public static SRPGAnimation makeObject(String fileName, int row, int col,
	...
	public static SRPGAnimation makeObject(String fileName, int tileWidth,
	...
	public final static SRPGAnimation makeObject(LImage[] down, LImage[] left,
